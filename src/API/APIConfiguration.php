...
use Kinikit\MVC\API\Languages\Java\JavaLanguageConfiguration;
use Kinikit\MVC\API\Languages\NodeJS\NodeJSLanguageConfiguration;
use Kinikit\MVC\API\Languages\PHP\PHPLanguageConfiguration;
...
class APIConfiguration {
     ...
     *
     * @var \Kinikit\MVC\API\APIGlobalParam[]
     */
    ...
    /**
     * @return \Kinikit\MVC\API\APIGlobalParam[]
     */
    ...
    public static function getAPIConfigs() {
        if (!self::$apiConfigs) {
            if (file_exists("Config/api.json")) {
                ...
                $configs = $converter->convert(file_get_contents("Config/api.json"), "\Kinikit\MVC\API\APIConfiguration[]");
