...
class APIObject extends DynamicSerialisableObject {
    ...
    /**
     * @var Kinikit\MVC\Framework\API\Descriptor\APIProperty[]
     */
     ...
     * @param string $name
     * @param $comment
     * @param Kinikit\MVC\Framework\API\Descriptor\APIProperty[] $properties
    ...
    /**
     * @return Kinikit\MVC\Framework\API\Descriptor\APIProperty[]
     */
